...
public class RegistrarCursoModel extends g41.si2022.mvc.Model {
	...
	public void insertSesion(String loc, String fecha, String horaIni, String horaFin, String cursoId) {
		String sql = "INSERT INTO sesion (loc, fecha, hora_ini, hora_fin, curso_id) VALUES (?, ?, ?, ?, ?)";
